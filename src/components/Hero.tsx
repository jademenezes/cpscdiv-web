const Hero = () => {
  return (
    <div className="hero-container d-flex justify-content-center align-items-center p-2 border border-primary">
      <div className="row row-cols-1 row-cols-lg-2 align-items-center">
        <div className="text-container">
          <h1 className="title p-2 mb-lg-5 border border-secondary">
            Bem vind@s ao II Colóquio Internacional e ao IV Colóquio de Pesquisa
            Social Crítico-dialética
          </h1>

          <div className="d-flex justify-content-between me-md-5 border border-success">
            <button className="btn btn-secondary hero-btn m-2">Sobre</button>
            <button className="btn btn-success hero-btn m-2">
              Faça sua inscrição!
            </button>
          </div>
          <p className="inf-paragraph py-2 px-2 mt-2 border border-danger">
